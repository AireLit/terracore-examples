 ...
 *
 * Usage:
 * TERRACORE_API_KEY=your_api_key node geoid.mjs
 *
 * Requires Node.js 18+
 */
...
async function main() {
  ...
  const response = await fetch("https://api.airelit.com/v1/terracore/geoid", {
    method: "POST",
    headers: {
      "X-API-Key": API_KEY,
  ...
  console.log("TerraCore GEOID Lookup Result:\n");
